...
module.exports = function (gulp, $) {
  ...
  //	Type: string | boolean
    ...
    function () {
      ...
      gulp.src(gulp.config.entry + '.styl')
      ...
      //	Gulp sourcemaps, source map support for Gulp.js
      //  NPM: https://www.npmjs.com/package/gulp-sourcemaps
        .pipe($.gulpSourcemaps.write(gulp.config.dest + '/css'))
